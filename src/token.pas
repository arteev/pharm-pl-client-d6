...
uses
  Classes, SysUtils, IdBaseComponent, IdCoder, IdCoder3To4, uLkJSON, Variants,
  unix_utils;
...
type
  ...
  public
    ...
    constructor CreateWithTokenFmt(const Token: string; const Msg: string; const Args: array of const);
...
constructor ExceptionToken.CreateWithToken(const Token: string; const Msg: string = '');
begin
  if Msg = '' then
...
constructor ExceptionToken.CreateWithTokenFmt(const Token, Msg: string; const Args: array of const);
begin
